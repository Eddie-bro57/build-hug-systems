...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BXozCpEM.mjs");
...
const manifest = {
  "59f653334e6e7f810ea4b23328818fd6c366c4425c8877cb0cabb28ca4237c6c": {
    functionName: "generateGuide_createServerFn_handler",
    importer: () => import("./guides.functions-BwcnSNxG.mjs")
  },
  "ddf3a97db7af5c8c9b645baecf6451a6f097d069fc5c7bf1dcfc444d6a95e5d8": {
    functionName: "quickFix_createServerFn_handler",
    importer: () => import("./ai.functions-DyMGA1fV.mjs")
  },
  "be859a15c39ba904bdf48e4e41378ba31a56c0fd609ddc630201b3f1c6171a43": {
    functionName: "troubleshoot_createServerFn_handler",
    importer: () => import("./ai.functions-DyMGA1fV.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B1HhPp6z.mjs").then((n) => n.r),
    import("./start-C0EC1yqA.mjs"),
